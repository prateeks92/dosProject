...
extern	devcall	lread(uint32);
extern	devcall	lwrite(uint32,char*);
extern	devcall	lsensor_aread(uint32);
extern	devcall	lsensor_read(uint32, uint32);
extern	devcall	lsensor_write(uint32,uint32, char*);
extern	devcall	lread_fifo(void);